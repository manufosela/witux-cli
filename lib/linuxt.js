...
console.log(pageDir);
  ...
  const filesToProcess = [
    ...
    { 'filename': 'common.html.mjs', 'path': path.join(__dirname,'..','_base','js', 'pages'), 'output': path.join(pageDir, 'js', 'pages', 'common.html.mjs') },
    { 'filename': '_base.json.js', 'path': path.join(__dirname,'..','_base','json'), 'output': path.join(pageDir, 'json', pageName + '.json.js') }
  ];
