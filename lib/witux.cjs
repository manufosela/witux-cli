 ...
 */
function how2use() {
  console.log('USE: witux [command] [options]\n');
  ...
  console.log('\n\t- scafolding: to generate all initial files to create a Witux static site');
...
async function createScafolding() {
  ...
  const filesToProcess = [
    ...
    { 'filename': 'witux.png', 'path': path.join('src', 'assets', 'images'), 'output': 'witux.png' },
